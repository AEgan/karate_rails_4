...
class SectionsControllerTest < ActionController::TestCase
  ...
  test "should update section" do
    patch :update, id: @section, section: { active: @section.active, event_id: @section.event_id, max_age: @section.max_age, max_rank: @section.max_rank, min_age: @section.min_age, min_rank: @section.min_rank }
    assert_redirected_to section_path(assigns(:section))
  end
